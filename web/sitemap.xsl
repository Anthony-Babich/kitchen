    ...
    <xsl:template match="/">
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
                <h1>XML Sitemap</h1>
                <p>
                    This sitemap was automatically generated by <a href="http://www.xn--b1ajv.xn--80adxhks/"><strong>зов.москва</strong></a> framework according to apps settled on this website.<br />
