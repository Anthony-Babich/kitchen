 ...
 * DesignProjectShag
 *
 * @ORM\Table(name="design_project_shag")
 * @ORM\Entity(repositoryClass="Kuhni\Bundle\Repository\DesignProjectShagRepository")
 */
class DesignProjectShag
{
    /**
